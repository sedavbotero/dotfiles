...
eval "$(oh-my-posh init bash --config '~/.config/oh-my-posh/bubblesextra_modified.json')"
...
case ":$PATH:" in
    *:/home/sedavbotero/.juliaup/bin:*)
        ;;

    *)
        export PATH=/home/sedavbotero/.juliaup/bin${PATH:+:${PATH}}
        ;;
esac
